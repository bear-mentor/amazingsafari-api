...
export type DataProduct = Omit<Product, "id" | "createdAt" | "updatedAt">;

export const dataSeedProducts: DataProduct[] = [
  {
  ...
  },
  {
    slug: "bali-starling",
    name: "Bali Starling",
    imageUrl: "https://safariwonders.com/wp-content/uploads/2023/06/t011xx000047-1686726398-480x480.jpg",
    price: 155000,
